      ...
      .then((res) => {
        if (!res.ok) {
          ...
          return res
            ...
            .then((err) => {
              const msg =
                err?.message || res.statusText || "No se pudo crear el envío";
              throw new Error(msg);
            });
        }
        return res.json();
        ...
        onClick={() => {
          if (user?.plan === "plus") {
            ...
            if (enviosPendientes >= 10) {
              toast.warning(
                "Has alcanzado el límite de 10 envíos pendientes del Plan Plus. Actualiza a Plan Premium para envíos ilimitados."
              );
              return;
            }
          }
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          >
            <div className="form-group">
              ...
              <input
                className={`form-input ${
                  errors.origenNumero ? "is-invalid" : ""
                }`}
                placeholder="1234"
            ...
            <div className="form-group">
              ...
              <input
                className={`form-input ${
                  errors.origenCiudad ? "is-invalid" : ""
                }`}
          ...
          <div className="form-group">
            ...
            <input
              className={`form-input ${
                errors.destinoCalle ? "is-invalid" : ""
              }`}
          ...
          >
            <div className="form-group">
              ...
              <input
                className={`form-input ${
                  errors.destinoNumero ? "is-invalid" : ""
                }`}
                placeholder="5678"
            ...
            <div className="form-group">
              ...
              <input
                className={`form-input ${
                  errors.destinoCiudad ? "is-invalid" : ""
                }`}
          ...
          >
            ...
            <div className="form-group">
              ...
              <input
                className={`form-input ${
                  errors.horaRetiroAprox ? "is-invalid" : ""
                }`}
                placeholder="14:30"
          ...
          >
            <div className="form-group">
              ...
              <select
                className={`form-input ${
                  errors.tamanoPaquete ? "is-invalid" : ""
                }`}
                defaultValue=""
